            ...
            <div className="formparentcontainer">
              <div className="formchildcontainer">
                ...
                <form  onSubmit={this.handlerSubmit}>
                  <input type="email" name="email" placeholder={translations[currentLanguage].Login.PlaceholderU}  onChange={e => this.inputHandeler(e)} />
                  <br />
                  {this.state.emailError}
                  <input type="password" name="password" placeholder={translations[currentLanguage].Login.PlaceholderP}  onChange={e => this.inputHandeler(e)} />
                  <br />
